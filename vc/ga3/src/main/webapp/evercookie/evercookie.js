...
var evercookie = (function () {
  this._class = function() {
    ...
    this.evercookie_lso = function(name, value)
    {
      ...
      swfobject.embedSWF("/evercookie/evercookie.swf", "swfcontainer", "1", "1", "9.0.0", false, flashvars, params, attributes);
    }
    ...
    */
      var source = "/evercookie/evercookie.xap";
    ...
    this.evercookie_history = function(name, value)
    {
      ...
      // sorry google.
      var url = 'http://www.yourdomain.com/evercookie/cache/' + this.getHost() + '/' + name;
